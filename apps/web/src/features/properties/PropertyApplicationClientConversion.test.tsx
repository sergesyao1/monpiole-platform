...
const application={applicationId:A,propertyId:P,inquiryId:"cccccccc-cccc-4ccc-8ccc-cccccccccccc",viewingId:"dddddddd-dddd-4ddd-8ddd-dddddddddddd",outcomeId:"eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee",status:"APPROVED"as const,createdAt:NOW,updatedAt:NOW,decidedAt:NOW,candidate:{contactName:"Awa Koné",email:"awa@example.com"},viewing:{startsAt:NOW,endsAt:NOW,timeZone:"UTC",completedAt:NOW},outcome:{status:"PROCEED"as const,decidedAt:NOW}};
