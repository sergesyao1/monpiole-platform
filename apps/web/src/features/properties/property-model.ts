...
export type PropertyApplicationStatus="SUBMITTED"|"APPROVED"|"REJECTED"|"WITHDRAWN";export interface PropertyApplication{readonly applicationId:string;readonly propertyId:string;readonly inquiryId:string;readonly viewingId:string;readonly outcomeId:string;readonly status:PropertyApplicationStatus;readonly note?:string;readonly createdAt:string;readonly updatedAt:string;readonly decidedAt?:string;}export interface PropertyApplicationListItem extends PropertyApplication{readonly candidate:{readonly contactName:string;readonly email?:string;readonly phoneNumber?:string};readonly viewing:{readonly startsAt:string;readonly endsAt:string;readonly timeZone:string;readonly completedAt?:string};readonly outcome:{readonly status:PropertyViewingOutcomeStatus;readonly note?:string;readonly decidedAt?:string};}export interface PropertyApplicationPage{readonly items:readonly PropertyApplicationListItem[];readonly pageInfo:{readonly hasNextPage:boolean;readonly nextCursor:string|null};}
